...
const BottomHeader = () => {
  return (
    <div className="flex items-center w-full h-10 gap-3 px-4 text-sm text-center text-white bg-amazon_light">
      ...
      <p className="hidden p-1 duration-300 border border-transparent md:inline-flex hover:border-red-600 hover:cursor-pointer text-amazon_yellow hover:text-red-400">
        Sign Out
      </p>
    </div>
  );
